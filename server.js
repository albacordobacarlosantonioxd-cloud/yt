...
app.post('/api/download', async (req, res) => {
    ...
    const ytdlpCommand = `yt-dlp --update --skip-download-video --no-check-certificate --no-cache-dir --cookies "${path.join(__dirname, 'cookies.txt')}" -f "best[ext=mp4]/best" -o "${outputPath}" "${videoUrl}"`;
